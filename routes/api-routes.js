        ...
        console.log("in /getImages/, req.params.id: ", req.params.id );
            ...
            .then((records) => {
                ...
                const formattedImages = imagesHold.map(buffer => {
                    ...
                    return `<img id="robotImg" alt="robotpic" data-title="` + records[0].title + `" data-id=` + records[0]._id + ` class="theImages" title="` + records[0].title + `" src="data:image/jpeg;base64,${buffer.toString("base64")}"/>`                    
                });
