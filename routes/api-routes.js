        ...
        console.log("in /getImages/, req.params.id: ", req.params.id );
            ...
            .then((records) => {
                ...
                const formattedImages = imagesHold.map(buffer => {
                    ...
                    return `<div class="robotTitles"><h4>` + records[0].title + `</h4><br><img data-id=` + records[0]._id + ` id="robotImg" class="theImages" title="` + records[0].title + `" alt="robotpic" src="data:image/jpeg;base64,${buffer.toString("base64")}"/></div>`
                });
